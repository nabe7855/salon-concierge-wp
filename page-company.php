...
<div class="bg-white min-h-screen pb-20 font-sans">
    <!-- Hero Section -->
    <section class="relative min-h-[600px] flex items-center overflow-hidden bg-white">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                ...
                <div class="w-full lg:w-1/2 text-left">
                    <div class="inline-flex items-center gap-3 mb-6">
                        <span class="w-12 h-px bg-[#c5a085]"></span>
                        <span class="text-[#c5a085] font-bold tracking-[0.4em] text-xs uppercase">About Our Vision</span>
                    </div>

                    <h1 class="relative mb-8 md:mb-10">
                        <span class="block text-3xl md:text-7xl font-bold font-heading text-[#3a5f56] leading-tight mb-2">どんな難題だって</span>
                        <span class="block text-2xl md:text-6xl font-bold font-heading text-[#3a5f56]/60 leading-tight">情熱と技術で<br />越えていく。</span>
                        <div class="absolute -left-4 top-0 w-1 h-2/3 bg-[#c5a085]/50 rounded-full"></div>
                    </h1>

                    <p class="text-gray-500 text-sm md:text-base leading-loose max-w-lg mb-12">
                        ビジネスを取り巻く課題を、人の温もりとITの力で解決する。<br />
                        そんな新しい可能性に満ちた未来を創造するのがSalon Conciergeです。<br />
                ...
                <div class="w-full lg:w-1/2 relative">
                    <div class="relative z-10 group">
                        <div class="relative rounded-[40px] md:rounded-[100px] overflow-hidden aspect-[4/3] md:aspect-square shadow-2xl">
    ...
    <section class="py-24 bg-gray-50/50 relative">
        <div class="container mx-auto px-6 max-w-5xl relative z-10">
            <div class="flex flex-col items-center text-center">
                ...
                <div class="relative mb-8 md:mb-16 px-6 md:px-12 py-12 md:py-16 bg-white/50 backdrop-blur-sm rounded-[32px] md:rounded-[40px] border border-white/50 shadow-sm max-w-3xl mx-auto">
                    ...
                    <h3 class="text-xl md:text-3xl font-bold text-gray-800 leading-tight mb-8">
                        「最高峰の対話力で、<br />サロンの可能性を最大化する。」
                    </h3>
                    <div class="space-y-6 text-gray-600 leading-loose text-lg">
                        <p>電話の一本一本に、サロンの未来が宿っています。<br />私たちはその重要性を深く理解し、業界トップクラスの応対スキルでお客様の期待を超える感動を届けます。</p>
                        <div class="pt-6 border-t border-gray-100 italic font-medium text-[#3a5f56]">メンズエステ特有の市場環境を熟知した専門集団として、貴社のビジネスに確かな付加価値をプラスし、唯一無二の存在として支え抜きます。</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6 max-w-5xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                foreach($values as $v): ?>
                    <div class="group bg-gray-50/50 p-8 rounded-[32px] border border-transparent hover:border-[#c5a085]/20 hover:bg-white hover:shadow-xl transition-all duration-500">
                        <div class="flex gap-6 items-start">
                            <div class="w-14 h-14 bg-white rounded-2xl shadow-sm flex items-center justify-center shrink-0 group-hover:bg-[#3a5f56] group-hover:text-white transition-colors duration-500">
                                <i data-lucide="diamond" class="text-[#c5a085] group-hover:text-white w-6 h-6"></i>
                            </div>
                            <div>
                                <h3 class="text-xl font-bold text-gray-800 mb-3 group-hover:text-[#3a5f56] transition-colors">
    ...
    <section class="py-24 bg-[#3a5f56] relative overflow-hidden">
        <div class="container mx-auto px-6 max-w-4xl relative z-10">
            <div class="text-center mb-16">
                <span class="text-[#c5a085] font-bold tracking-widest text-xs mb-4 uppercase">Overview</span>
                <h2 class="text-3xl md:text-4xl font-bold font-heading text-white">会社概要</h2>
            </div>

            <div class="bg-white rounded-[40px] shadow-2xl overflow-hidden p-8 md:p-16">
                <div class="space-y-0">
                    <?php 
                    $info = [
                    ...
                    foreach($info as $row): ?>
                        <div class="flex flex-col md:flex-row border-b border-gray-100 py-6 last:border-0 group hover:bg-gray-50/50 transition-colors px-4 -mx-4 rounded-xl">
                            <span class="md:w-1/3 font-bold text-gray-400 text-sm mb-1 md:mb-0 uppercase tracking-wider"><?php echo $row['label']; ?></span>
                            <span class="md:w-2/3 text-gray-700 font-medium"><?php echo $row['content']; ?></span>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
