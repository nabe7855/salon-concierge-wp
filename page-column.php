...
<div class="bg-[#fcfcfc] min-h-screen pb-20 font-sans">
    ...
    <div class="bg-white border-b border-gray-100">
        <div class="container mx-auto px-4 py-3 text-[10px] text-gray-400">
            <a href="<?php echo esc_url(home_url('/')); ?>" class="hover:text-salon-pink transition-colors">トップ</a> &gt; <span class="text-gray-600 font-bold">コラム</span>
        </div>
    </div>
        ...
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2 space-y-12">
                    ...
                    ?>
                        <div class="text-center py-20 bg-white rounded-[32px] border border-gray-100 italic text-gray-400">記事が見つかりませんでした</div>
                    <?php
                    endif;
                    wp_reset_postdata();
                    ?>
                ...
                <div class="lg:col-span-1 space-y-10">
                    ...
                    <div class="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm">
                        ...
                        <form role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                            <div class="relative">
                                <input type="search" name="s" placeholder="キーワードを入力" class="w-full bg-salon-light border border-salon-tan/30 rounded-full px-6 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-salon-pink/20">
                            </div>
                        </form>
                    </div>
                    ...
                    <!-- Social / About Mini -->
                    <div class="bg-[#d4a373] rounded-[32px] p-8 text-white relative overflow-hidden">
                        <?php salon_icon('leaf', 'absolute -bottom-10 -right-10 opacity-20 w-40 h-40'); ?>
                        <h3 class="text-lg font-bold mb-4 relative z-10">SalonConcierge Column</h3>
                        <p class="text-xs leading-relaxed opacity-90 relative z-10">メンズエステ業界の最新トレンドや、現場で役立つ実践的なノウハウをお届けします。</p>
                    </div>
                </div>
            </div>
        </div>
